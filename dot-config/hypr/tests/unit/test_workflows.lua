...
return {
  ...
  },
  {
    ...
    run = function()
      ...
      -- 12 apps + 3 window + 4 focus + 4 move + 4 resize + 4 monitor
      -- + 2 special + 4 mouse + 10 media + 2 screenshots + 20 workspaces = 69
      assert(#list == 69, "expected 69 binds, got " .. tostring(#list))
    end,
  },
  {
